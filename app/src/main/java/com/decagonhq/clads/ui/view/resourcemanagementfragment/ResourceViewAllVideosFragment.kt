 ...
 * Use the [ResourceViewAllVideosFragment.newInstance] factory method to
...
class ResourceViewAllVideosFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ResourceViewAllVideosFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ResourceViewAllVideosFragment().apply {
