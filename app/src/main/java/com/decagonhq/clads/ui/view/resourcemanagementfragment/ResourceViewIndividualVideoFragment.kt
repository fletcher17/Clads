 ...
 * Use the [ResourceViewIndividualVideoFragment.newInstance] factory method to
...
class ResourceViewIndividualVideoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ResourceViewIndividualVideoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ResourceViewIndividualVideoFragment().apply {
